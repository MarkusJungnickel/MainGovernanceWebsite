...
} from "src/logic/contractInteraction/sources/ABIService";
...
export const MethodsDropdown = ({
  onChange,
}: MethodsDropdownProps): ReactElement | null => {
  ...
  const [selectedMethod, setSelectedMethod] = useState(
    selectedMethodByDefault ? selectedMethodByDefault : {}
  );
  ...
  useEffect(() => {
    setMethodsListFiltered(
      methodsList.filter(({ name }) =>
            ...
            >
              <StyledText
                ...
                className={classNames(
                  buttonClasses.buttonInner,
                  anchorEl && buttonClasses.openMenuButton
                )}
              >
                  ...
                  return (
                    ...
                    >
                      ...
                      <ListItemIcon className={classes.iconRight}>
                        {signatureHash ===
                        (selectedMethod as Record<string, string>)
                          .signatureHash ? (
